...
export function GenTestoImmagine({
  ...
  if (isStack) {
    ...
    return (
      <section
        className={cn(
          'relative overflow-hidden flex flex-col gap-(--spacing-content)',
          className,
        )}
      >
        <div
        ...
        >
          <div className="md:max-w-lg">{textBlock}</div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="md:hidden px-(--spacing-page)">{textBlock}</div>
      ...
      <div className="relative">
        ...
        <div
          className={cn(
            ...
            isTextRight ? 'right-0 rounded-l-2xl' : 'left-0 rounded-r-2xl',
          )}
        />
