...
export interface ProductTypeConfig {
  ...
  /** Parent NID(s) for "other pages" section in hub (descriptive categories) */
  otherPagesParentNid?: number | number[];
}
...
export const FILTER_REGISTRY: Record<string, ProductTypeConfig> = {
  ...
  prodotto_vetrite: {
    ...
    filters: {
      ...
      finish: {
        ...
        type: 'query',
        queryKey: 'finish',
        taxonomyType: 'taxonomy_term--vetrite_finiture',
        displayAs: 'checkboxes',
        multiSelect: false,
        priority: 'P1',
      },
  ...
  prodotto_tessuto: {
    ...
    filters: {
      ...
      tipologia: {
        key: 'tipologia',
        drupalField: 'field_tipologia.name',
        type: 'query',
        queryKey: 'tipologia',
        taxonomyType: 'taxonomy_term--tessuto_tipologie',
        displayAs: 'checkboxes',
