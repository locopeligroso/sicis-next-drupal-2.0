    ...
    const { error } = await resend.emails.send({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;width:100%;max-width:600px">
          ...
          <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold">Prodotto</td><td style="padding:8px;border:1px solid #ddd">${safeProdotto}</td></tr>
